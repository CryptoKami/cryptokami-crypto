...
foreign import ccall "cryptokami_crypto_ed25519_publickey"
    ccryptonite_ed25519_publickey :: Ptr SecretKey -- secret key
                                  -> Ptr PublicKey -- public key
                                  -> IO ()

foreign import ccall "cryptokami_crypto_ed25519_sign_open"
...
foreign import ccall "cryptokami_crypto_ed25519_sign"
...
foreign import ccall "cryptokami_crypto_ed25519_point_add"
    ccryptonite_ed25519_point_add :: Ptr PublicKey -- p1
                                  -> Ptr PublicKey -- p2
                                  -> Ptr PublicKey -- p1 + p2
                                  -> IO ()

foreign import ccall "cryptokami_crypto_ed25519_scalar_add"
